...
<body>
	<!-- 템플렛1 수정 전용 견본페이지입니다. 삭제하셔도됩니다. -->
	<jsp:include page="../header.jsp"></jsp:include>
	
	<!--================ Start Header Menu Area =================-->
    <nav class="navbar navbar-expand-lg navbar-light shadow">
        <div class="container d-flex justify-content-between align-items-center">
            <a class="navbar-brand text-success logo h1 align-self-center" href="index.html">상호명</a>
        ...
        <div class="row">
		 <div class="col-lg-3">
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
               <%--              <c:forEach var="plist" items="${plist}"> 상품리스트반복--%>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="shop-single.html" class="h3 text-decoration-none">상품명</a>
                                ...
                                <p class="text-center mb-0">상품금액</p>
                            </div>
                        </div>
                    </div>
                <div div="row">
