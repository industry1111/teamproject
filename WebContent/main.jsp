...
<script type="text/javascript">
	...
	function btn_click(product_num) {
		child = window.open("Report.st?product_num="+product_num,"child","width=750,height=700");
	}
				...
				<c:forEach var="i" begin="${p.beginPerPage }" step="1" end="${p.endPerPage}">
					...
					<div class="row">
						...
						<br>
							...
							<a id="report" onclick="btn_click(${plist[i].product_num});">	
