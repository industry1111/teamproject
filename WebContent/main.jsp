				...
				<c:forEach var="i" begin="${p.beginPerPage }" step="1" end="${p.endPerPage}">
					...
					<div class="row">
						...
						<br>
							...
							<c:forEach var="j" begin="0" step="1" end="${jlist.size() }">
										<c:if test="${slist[i].store_num eq jlist[j].store_num }">
											<a id="jjim"  class="jjim" value="${slist[i].store_num}">
