...
<script type="text/javascript">
	...
	function btn_click(member_num,product_num) {
		child = window.open("Report.st?member_num="+member_num+"&product_num="+product_num,"child","width=600,height=650");
	}
				...
				<c:forEach var="i" begin="${p.beginPerPage }" step="1" end="${p.endPerPage}">
					...
					<div class="row">
						...
						<br>
							...
							<a id="report" onclick="btn_click(${slist[i].member_num},${plist[i].product_num});">	
