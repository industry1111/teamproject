				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<ul class="product-btns">
								<li><a href="#"><i class="fa fa-heart-o"></i>위시리스트에추가하기</a></li>
								<li><a href="#"><i class="fa fa-exchange"></i>다른제품과비교하기</a></li>
							</ul>
						</div>
					</div>
					<!-- 상품상세보기 끝 -->
					...
					<div class="col-md-12">
						<div id="product-tab">
							<!-- product tab nav -->
							<ul class="tab-nav">
								<li class="active"><a data-toggle="tab" href="#tab1">상품설명</a></li>
										...
										<div class="col-md-3">
											<div id="review-form">
												<form class="review-form">
													...
													<textarea class="input" placeholder="리뷰"></textarea>
													...
													<button class="primary-btn">전송하기</button>
												</form>
											</div>
										</div>
										<!-- 리뷰 폼 끝 -->
