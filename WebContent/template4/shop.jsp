<<<<<<< HEAD:WebContent/template4/shop.jsp
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-4 col-md-5">
          ...
          <div class="sidebar-filter">
            <div class="top-filter-head">카테고리2</div>
            ...
            <div class="row">
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    <p>Accessories</p>
                    <h4 class="card-product__title"><a href="single-product-user.jsp">Quartz Belt Watch</a></h4>
                    <p class="card-product__price">$150.00</p>
                  </div>
                </div>
              </div>
...
>>>>>>> ff9bd9938c46f05410061d2f280d4a923da64edc:WebContent/templete4/shop.jsp
</html>