...
public class SearchProductList extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		for (int i = 0; i < plist.size(); i++) {
			...
			json += "{\"product_img\":\"" + product_img + "\",\"category_name\":\"" + category_name
					+ "\",\"product_name\":\"" + product_name + "\",\"category_name\":\"" + category_name + "\","
					+ "\"product_description\":\"" + product_description + "\",\"store_name\":\"" + store_name
					+ "\",\"store_num\":\"" + store_num + "\"," + "\"profile_img\":\"" + profile_img
					+ "\",\"template\":\"" + template + "\",\"category_num\":\"" + category_num
					+ "\",\"product_price\":\"" + product_price + "\"" + ",\"regdate\":\"" + regdate
					+ "\",\"category_coderef1\":\"" + category_coderef1 + "\"" + ",\"category_coderef2\":\""
					+ category_coderef2 + "\",\"category_code1\":\"" + category_code + "\",\"product_num\":\""
					+ product_num + "\"}";
			if (i != plist.size() - 1) {
				json += ",";
			}
		...
		json += "{\"startPage\":\"" + pagedto.getStartPage() + "\",\"endPage\":\"" + pagedto.getEndPage()
				+ "\",\"beginPerPage\":\"" + pagedto.getBeginPerPage() + "\",\"endPerPage\":\""
				+ pagedto.getEndPerPage() + "\"," + "\"prev\":\"" + pagedto.isPrev() + "\",\"next\":\""
				+ pagedto.isNext() + "\",\"total\":\"" + pagedto.getTotal() + "\",\"nowPage\":\""
				+ pagedto.getCri().getNowPage() + "\"}";
